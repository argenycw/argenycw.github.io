                ...
                **/
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    for(var i = 0; i < audioSequence.data.length; ++i) {
                        ...
                        // sustain
                        else if (i >= attackDuration + decayDuration && i < audioSequence.data.length - releaseDuration) {
                        	audioSequence.data[i] *= sustainLevel;
                        }
                        // release
                        else {
                        	var multiplier = (audioSequence.data.length - i) / releaseDuration;
                        	audioSequence.data[i] *= multiplier * sustainLevel;
                        }
                    }
                ...
                **/
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    for (var i = 0; i < audioSequence.data.length; i++) {
                        ...
                        var multiplier = 0.5 * (1 + Math.sin(2 * Math.PI * tremoloFrequency * currentTime - Math.PI/2));
                        audioSequence.data[i] *= (1 - wetness) + wetness * multiplier;
                    }
                ...
                **/
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    for(var i = 0; i < audioSequence.data.length; ++i) {
                        ...
                        var delayedSample = delayLine[i % delayLineSize];
                        // Add the echoed sample to the current sample, with a multiplier
                        audioSequence.data[i] += delayedSample * multiplier;
