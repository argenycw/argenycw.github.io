// ===============================================================
// This is a shared-source RoundBox that material can be applied
// effectively.
// Return a THREE.BufferGeometry with the shape of a rounded box
// ===============================================================
function RoundEdgedBox(w, h, d, r, wSegs=4, hSegs=4, dSegs=4, rSegs=4) {
  	w = w || 1;
    h = h || 1;
    d = d || 1;
